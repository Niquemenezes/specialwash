...
export default function CocheSustitucionPage() {
  ...
  if (vista === "nuevo") {
    return (
      ...
      <div className="container py-4" style={{ maxWidth: 860, color: "#eef2f7", position: "relative", zIndex: 3 }}>
        ...
        <div style={{ ...sectionCardStyle, marginBottom: "1rem" }}>
          <div style={sectionBodyStyle}>
            <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
              ...
              <span className="badge rounded-pill text-bg-dark" style={{ border: "1px solid #30394a", padding: "0.65rem 0.9rem" }}>
                Formulario activo
              </span>
            </div>
          </div>
  ...
  return (
    <div className="sw-page-bg" style={pageShellStyle}>
    <div className="container py-4" style={{ color: "#eef2f7", position: "relative", zIndex: 3 }}>
      <div style={{ ...sectionCardStyle, marginBottom: "1rem" }}>
        <div style={sectionBodyStyle}>
          <div className="d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <div>

...
export default function HorariosAdminPage() {
  ...
  const handleImprimir = (filas) => {
    ...
    const titulo = `SW Studio — Horarios — ${periodoLabel}${empleadoNombre ? " — " + empleadoNombre : ""}`;
...
<body>
  <h2>SW Studio — Control de horarios</h2>
  <p>${titulo.replace("SW Studio — Horarios — ", "")}</p>
  <table>
    <thead><tr>
    ...
    <>
      ...
      <div className="container-fluid py-4">
        ...
        <div className="horario-print-header mb-3">
          <strong style={{ fontSize: 15 }}>SW Studio — Control de horarios</strong>

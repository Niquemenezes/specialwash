...
const MODULES = [
  ...
  },
  {
    ...
    accent: "#6366f1",
    to: () => "/partes?hub=1",
    cta: "Abrir vista por roles",
    links: () => [
      { to: "/partes-trabajo", label: "Partes en tarjetas", detail: "Vista clásica de partes para seguimiento operativo" },
      { to: "/partes?hub=1", label: "Vista por roles", detail: "Ver los coches agrupados por detailing, pintura y tapicería" },

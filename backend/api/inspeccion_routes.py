...
# ============================================================
# TABLA DE REGISTROS (vista tipo Google Sheets)
# ============================================================
...
@inspeccion_bp.route("/tabla-registros", methods=["GET"])
@jwt_required()
...
@inspeccion_bp.route("/tabla-registros/<int:inspeccion_id>", methods=["PATCH"])
@jwt_required()
@role_required("administrador", "calidad")
...
@inspeccion_bp.route("/inspeccion-recepcion/<int:inspeccion_id>/revertir-entrega", methods=["POST"])
@jwt_required()
@role_required("administrador")

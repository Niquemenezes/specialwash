...
Revision ID: 952d200bec94
Revises: 
Create Date: 2025-07-14 07:27:20.256304
...
def upgrade():
    ...
    sa.Column('producto_id', sa.Integer(), nullable=False),
    sa.Column('proveedor_id', sa.Integer(), nullable=False),
    sa.Column('numero_albaran', sa.String(length=100), nullable=False),
    ...
    sa.Column('precio_final_pagado', sa.Float(), nullable=True),
    sa.Column('observaciones', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['producto_id'], ['producto.id'], ),
    sa.ForeignKeyConstraint(['proveedor_id'], ['proveedor.id'], ),
    sa.PrimaryKeyConstraint('id')

import paramiko
ssh=paramiko.SSHClient(); ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy()); ssh.connect('194.164.164.78', username='root', password='***REDACTED-PASSWORD***', timeout=20)
for c in [
